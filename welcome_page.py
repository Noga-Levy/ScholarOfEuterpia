...
st.markdown("<h4 style='text-align: center;'>And, a millennium later, Euterpia has been restored to its former glory"
...
st.markdown("<h2 style='text-align: center;'>There's still one missing piece that's keeping the land from achieving "
            "true harmony. The Scholars have sent their best--that's you!--to go retrieve it.</h2>",
            unsafe_allow_html=True)
